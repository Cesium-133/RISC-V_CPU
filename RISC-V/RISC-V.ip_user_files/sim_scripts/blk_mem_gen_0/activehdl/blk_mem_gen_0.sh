...
#
# Generated by Vivado on Thu Dec 12 22:43:40 +0800 2024
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="D:/Course/Digital_Logic_Fundementals/Projects/CPU/RISC-V_CPU/RISC-V/RISC-V.cache/compile_simlib/activehdl"
  fi
